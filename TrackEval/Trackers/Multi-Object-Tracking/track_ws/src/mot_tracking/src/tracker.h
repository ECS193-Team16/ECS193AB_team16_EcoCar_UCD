...
public:
	...
	Tracker(Param& p):param_(p){
		...
		track_id_ = 0;	
		filewrite.open("~/tmp/log_tracker", std::ios::out|std::ios::app);
		//this array  stores the critical values of the chi-squared distribution with 1 to 6 degrees of freedom, at a significance level of 0.025
		chi2in975[1] = 5.025;
		chi2in975[2] = 7.378;
		chi2in975[3] = 9.348;
		chi2in975[4] = 11.143;
